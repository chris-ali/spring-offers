...
import com.chrisali.spring.web.validation.ValidEmail;

@Entity
@Table(name="messages")
public class Message implements Serializable {
	
	private static final long serialVersionUID = -3641808468241264063L;
	...
	public Message(int id, String subject, String content, String name, String email, String username) {
		this(subject, content, name, email, username);
		this.id = id;
	}
